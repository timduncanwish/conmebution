...
export interface WeChatMPCredentials extends PlatformCredentials {
  appId: string;
  appSecret: string;
  accountId?: string;
}

export interface WeChatMPUploadResult {
  mediaId: string;
  url: string;
  createdAt: number;
}
...
export class WeChatMPAdapter extends BasePlatformAdapter {
  private apiClient: AxiosInstance;
  private wechatCredentials: WeChatMPCredentials;
  private accessToken?: string;

  constructor(credentials: WeChatMPCredentials) {
