...
export class XiaohongshuAdapter extends BasePlatformAdapter {
  private xiaohongshuCredentials: XiaohongshuCredentials;
   ...
   */
  async getPublishPageStatus(): Promise<{
    canPublish: boolean;
 ...
 */
export async function createXiaohongshuAdapterWithOpenClaw(
  credentials: XiaohongshuCredentials
): Promise<XiaohongshuAdapter> {
