...
const batch_publisher_service_1 = require("../../services/platforms/batch-publisher.service");
const router = (0, express_1.Router)();
const batchPublisher = new batch_publisher_service_1.BatchPublisherService();
/**
...
router.post('/publish', async (req, res) => {
    try {
        const { content, platforms, credentials, options = {}, } = req.body;
        ...
        const taskId = await batchPublisher.createBatchPublishTask(content, platforms, credentialsMap, options);
        res.json({
            success: true,
            data: {
                taskId,
